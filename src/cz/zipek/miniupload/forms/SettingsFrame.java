...
public class SettingsFrame extends javax.swing.JFrame implements Listener<Event> {
	...
	public SettingsFrame() {
		...
		setIconImage(new ImageIcon(this.getClass().getResource("/cz/zipek/miniupload/res/settings.png")).getImage());
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tabbedMain, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE)
