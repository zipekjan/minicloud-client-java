...
public class Forms {
	 ...
	 */
	public static void showDownload(List<cz.zipek.miniupload.api.File> files) {
	 ...
	 */
	public static void showDelete(List<cz.zipek.miniupload.api.File> files) {
	 ...
	 */
	public static void showMove(List<cz.zipek.miniupload.api.File> files) {
	 ...
	 */
	public static void showFile(cz.zipek.miniupload.api.File file) {
		FileFrame frame;
